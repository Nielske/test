        ...
        builder.setView(dialogView)
                ...
                .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        EditText editProduct = (EditText) dialogView.findViewById(R.id.editText);
                        String product = editProduct.getText().toString();
                        EditText editCount = (EditText) dialogView.findViewById(R.id.editText2);
                        int count = Integer.valueOf(editCount.getText().toString());
                        EditText editPrice = (EditText) dialogView.findViewById(R.id.editText3);
